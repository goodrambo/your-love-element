...
- A shared golden fixture now passes through both the protected Worker scorecard route and local adapter, requiring identical range, goal/streak, totals, days, and deterministic attribution ordering so contract drift fails CI before release.
